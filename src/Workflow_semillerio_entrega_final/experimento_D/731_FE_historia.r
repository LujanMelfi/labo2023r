...
PARAM <- list()
PARAM$experimento <- "FE7314D"

PARAM$exp_input <- "DR7210"

PARAM$lag1 <- TRUE
PARAM$lag2 <- TRUE
PARAM$lag3 <- TRUE # activo este lag (en los anteriores desactivado)
...
PARAM$Tendencias3$ventana <- 12 # aumento de 6 a 12
...
PARAM$CanaritosAsesinos$ratio <- 2.0 # sube a 2.0
