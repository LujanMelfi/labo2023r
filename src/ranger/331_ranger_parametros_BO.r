...
param <- list(
  "num.trees" = 240, # cantidad de arboles
  "mtry" = 8,
  "min.node.size" = 347, # tamaño minimo de las hojas
  "max.depth" = 28 # 0 significa profundidad infinita
)

set.seed(980717) # Establezco la semilla aleatoria
...
archivo_salida <- "./exp/KA3310/KA3310_BO.csv"
