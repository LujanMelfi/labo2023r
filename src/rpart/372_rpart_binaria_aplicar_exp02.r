...
PARAM$rpart$cp <- -0.335049242920560

PARAM$rpart$minsplit <- 1311.66235908795

PARAM$rpart$minbucket <- 653.014358410091
...
for (corte in c(8500, 9000, 9500, 10000, 10500, 11000, 11500)) {
  ...
  fwrite(dfinal[, list(numero_de_cliente, Predicted)],
         file = paste0(PARAM$experimento, "_002_", corte, ".csv"),
         sep = ","
  )
}