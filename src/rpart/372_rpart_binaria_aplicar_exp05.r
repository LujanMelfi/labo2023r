...
PARAM$rpart$cp <- -0.319553317867126

PARAM$rpart$minsplit <- 1271.95543269783

PARAM$rpart$minbucket <- 610.213491906086
...
for (corte in c(8500, 9000, 9500, 10000, 10500, 11000, 11500)) {
  ...
  fwrite(dfinal[, list(numero_de_cliente, Predicted)],
         file = paste0(PARAM$experimento, "_005_", corte, ".csv"),
         sep = ","
  )
}