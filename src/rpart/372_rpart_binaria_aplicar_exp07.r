...
PARAM$rpart$cp <- -0.999361476527296

PARAM$rpart$minsplit <- 1186.15860558861

PARAM$rpart$minbucket <- 587.361533955699
...
for (corte in c(8500, 9000, 9500, 10000, 10500, 11000, 11500)) {
  ...
  fwrite(dfinal[, list(numero_de_cliente, Predicted)],
         file = paste0(PARAM$experimento, "_007_", corte, ".csv"),
         sep = ","
  )
}