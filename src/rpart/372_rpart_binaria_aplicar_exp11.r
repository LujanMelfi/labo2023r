...
PARAM$rpart$cp <- -0.977065805605150

PARAM$rpart$minsplit <- 1145.20041368479

PARAM$rpart$minbucket <- 568.070474406194
...
for (corte in c(8500, 9000, 9500, 10000, 10500, 11000, 11500)) {
  ...
  fwrite(dfinal[, list(numero_de_cliente, Predicted)],
         file = paste0(PARAM$experimento, "_011_", corte, ".csv"),
         sep = ","
  )
}