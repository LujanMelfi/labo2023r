...
PARAM$rpart$cp <- -0.214101599133833
  
PARAM$rpart$minsplit <- 1360.46153481204

PARAM$rpart$minbucket <- 671.449034264210
...
for (corte in c(8500, 9000, 9500, 10000, 10500, 11000, 11500)) {
  ...
  fwrite(dfinal[, list(numero_de_cliente, Predicted)],
         file = paste0(PARAM$experimento, "_012_", corte, ".csv"),
         sep = ","
  )
}