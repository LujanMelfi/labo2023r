...
PARAM$rpart$cp <- -0.374082588862962

PARAM$rpart$minsplit <- 1882.00136944068

PARAM$rpart$minbucket <- 627.623011585860
...
for (corte in c(8500, 9000, 9500, 10000, 10500, 11000, 11500)) {
  ...
  fwrite(dfinal[, list(numero_de_cliente, Predicted)],
         file = paste0(PARAM$experimento, "_016_", corte, ".csv"),
         sep = ","
  )
}