...
PARAM$rpart$cp <- -0.405121273254884

PARAM$rpart$minsplit <- 1525.72667250362

PARAM$rpart$minbucket <- 606.677576253359
...
for (corte in c(8500, 9000, 9500, 10000, 10500, 11000, 11500)) {
  ...
  fwrite(dfinal[, list(numero_de_cliente, Predicted)],
         file = paste0(PARAM$experimento, "_019_", corte, ".csv"),
         sep = ","
  )
}