...
PARAM$rpart$cp <- -0.580426781794187

PARAM$rpart$minsplit <- 2044.53393370038

PARAM$rpart$minbucket <- 597.558696798191
...
for (corte in c(8500, 9000, 9500, 10000, 10500, 11000, 11500)) {
  ...
  fwrite(dfinal[, list(numero_de_cliente, Predicted)],
         file = paste0(PARAM$experimento, "_023_", corte, ".csv"),
         sep = ","
  )
}