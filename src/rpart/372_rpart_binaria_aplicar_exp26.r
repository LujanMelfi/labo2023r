...
PARAM$rpart$cp <- -0.655922016799316

PARAM$rpart$minsplit <- 2032.94299966827

PARAM$rpart$minbucket <- 651.987301547093
...
for (corte in c(8500, 9000, 9500, 10000, 10500, 11000, 11500)) {
  ...
  fwrite(dfinal[, list(numero_de_cliente, Predicted)],
         file = paste0(PARAM$experimento, "_026_", corte, ".csv"),
         sep = ","
  )
}