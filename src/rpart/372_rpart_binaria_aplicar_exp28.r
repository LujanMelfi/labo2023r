...
PARAM$rpart$cp <- -0.643731430386176

PARAM$rpart$minsplit <- 1992.08918226079

PARAM$rpart$minbucket <- 636.673231921467
...
for (corte in c(8500, 9000, 9500, 10000, 10500, 11000, 11500)) {
  ...
  fwrite(dfinal[, list(numero_de_cliente, Predicted)],
         file = paste0(PARAM$experimento, "_028_", corte, ".csv"),
         sep = ","
  )
}