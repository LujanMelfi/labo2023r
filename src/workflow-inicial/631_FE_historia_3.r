...
PARAM <- list()
PARAM$experimento <- "FE6310_03"

PARAM$exp_input <- "DR6210_03"

PARAM$lag1 <- TRUE # agrega para cada variable el valor del mes anterior
PARAM$lag2 <- TRUE # agrega para cada variable el valor de dos meses antes
PARAM$lag3 <- FALSE # agrega para cada variable el valor de tres meses antes

# agrega para cada variable la pendiente que ajusta por cuadrados minimos 
# el valor de ese mes y los cinco meses anteriores
